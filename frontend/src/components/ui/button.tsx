...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-brick-600 text-white hover:bg-brick-700 active:bg-brick-800",
        dark: "bg-black text-white hover:bg-brick-950",
        outline: "border border-black bg-transparent text-black hover:bg-black hover:text-white",
        ghost: "bg-transparent text-black hover:bg-brick-100",
        link: "bg-transparent underline underline-offset-4 text-brick-700 hover:text-brick-900 p-0",
      },
      size: {
        default: "h-11 px-6",
        sm: "h-9 px-4 text-sm",
